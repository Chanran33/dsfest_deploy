...
const TimeDay20 = () => {
  return (
    <div className={s.body20}>
      ...
      <TimeItem title={"총학생회 콘텐츠"} time={"18:30~20:00"} location={"영근터"} color={"#D0C7DE"} height={"142px"} name={s.item10} />
      <TimeItem title={"공연"} time={"20:00~21:00"} location={"영근터"} color={"#E7D0B6"} height={"99px"} name={s.item11} />
    </div>
  );
};
